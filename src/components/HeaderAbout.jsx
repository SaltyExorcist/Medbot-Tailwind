        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:block">
            <ul className="flex space-x-8">
              ...
              <li>
                <a href="/about" className="px-4 py-2 bg-red-500 text-white rounded-full hover:bg-red-600 transition-colors">
                  About us
                </a>
              </li>
              <li>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-200">
            <ul className="flex flex-col space-y-3 px-2">
              <li>
                <a href="/" className="block px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded">
                  Home
                </a>
              </li>
              <li>
                <a href="/about" className="block px-4 py-2 bg-red-500 text-white rounded-full text-center">
                  About us
                </a>
              </li>
              <li>
